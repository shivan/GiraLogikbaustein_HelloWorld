...
## -----------------------------------------------------
## Copyright (c) '''+ time.strftime("%Y") + ''', Markus Stein, All rights reserved.
##
## This program is free software; you can redistribute it and/or modify it under the terms
## of the GNU General Public License as published by the Free Software Foundation; either
## version 3 of the License, or (at your option) any later version.
...
5000|"'''+LOGIKCAT+'''\\'''+LOGIKNAME+'''_'''+VERSION+'''"|0|2|"Eingang 1"|"Eingang 2"|1|"Ausgang 1"

5001|2|1|0|1|1

# EN[x]
5002|1|"test1"|1 #* Eingang 1
5002|2|"test2"|1 #* Eingang 2

# Speicher
5003|1||0 #* Class storage

# Ausgänge
5004|1|""|0|1|1 #* Ausgang 1
...
## Class on SN1
5012|1|"EI"|"hello_world(EN[1])"|""|0|0|1|0

## Say hello when telegram is on EN2 and text on EN2 is more than 0 length
5012|0|"EC[2] and len(EN[2])>0"|"SN[1].say_hello(EN[2])"|""|0|0|0|0
